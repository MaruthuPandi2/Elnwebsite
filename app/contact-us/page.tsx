...
<div className="col-md-5 px-5">
      ...
      <div className="contact_info_item">
        ...
        <p className="f_400 f_size_15"><span className="f_400">For product enquiries and questions contact :</span> <br />
          <a href="mailto:support@agaramtech.com">sales@agaramtech.com</a>
        </p>
        <p className="f_400 f_size_15"><span className="f_400">Customer Support Portal</span> <br />
          <a href="https://support.agaramtech.com/" target="_blank" rel="noopener noreferrer">agaramtech.freshdesk.com</a>
        </p>
      </div>
      <div className="contact_info_item">
        ...
        <a href="https://goo.gl/maps/my3amtgSubVdu9ZN6" target="_blank" rel="noopener noreferrer"><u>View Map</u></a><br />
        <br />
        <p className="f_400 f_size_15">
          <b>South Korea</b><br />
