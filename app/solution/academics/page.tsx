              ...
              <div className="row">
                  <div className="col-lg-6 mt-5">
                    <div className="mt-2">
                      ...
                      <p>Simplify your research process without breaking the budget</p>
                      <li className="bullet_none mt-4">
                        ...
                        Free for up to 90 days for academic users
                      </li>
                      <li className="bullet_none mt-4">
                        ...
                        <span>
                          Free for 10 users in academic lab team
                        </span>
                      </li>
                      <li className="bullet_none mt-4 acadyfontposition">
                        <Image src={discount_hand} className="img-fluid" style={{marginRight:"8px"}} 
                        alt="Upgrade from Logilab ELN Lite to Premium for added discounts"/>
                        <span>
                        Get <del>30%</del> 40% off + added  10%  annual discount when you  upgrade from Logilab ELN Lite to Logilab ELN Premium
                        </span>
                      </li>
