...
export default function Solution() {
  ...
  const facts = [
    {  
      count: 84,
      text: 'Increase in lab workflow efficiency',
      style:{ rotate: "180deg" }
    },
    {
      count: 65,
  ...
  <div className="home-colour">
            ...
            <div className="container security_banner_content">
                <div className="row">
                    <div className="col-lg-12 wow fadeInRight headerposition text-center mt_56" data-wow-delay="0.2s ">
                       <h1 className="wow fadeInUp " data-wow-delay="0.3s">Record, execute, collaborate, store</h1>
                 ...
                 <div className="section_container">
                     <div className="intro">
                         <div className=" intro_content">
                            ...
                            <h2 className="splash sectiontitlesize" style={{color:'#1163ea'}}>One Size Fits All</h2>                              
                               ...
                               <div className='container contentcolor'>
                                    ...
                                    <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                      <Image src={Perfect_Start_Section} className="img-fluid   sizechangemobile" 
                                    ...
                                    <div className="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                      <Image src={researchfaster} className="img-fluid   sizechangemobile" 
                                      alt="Adhere to ALCOA data integrity principles with Logilab ELN's Spreadsheet and Protocol templates — attach 
                                      numeric data, chemical drawings, formulas, images and more."/>
                                    </div>
                                    <div className="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                      <Image src={All_on_record} className="img-fluid   sizechangemobile" 
                                      alt="Ensure data security with Logilab ELN's multi-level permissions across projects, 
                                      comprehensive audit trails, secure electronic signatures and more."/>
                                    </div>
                                    </div>
                                    </div>
                                    </div>
   ...
   <div className='container tab2 mt-5'>
        <div className="hosting_title sec_title erp_title text-center headersizechange mb-4 pt-5">
             <h2 className="mt-4 text-center star headersizech">Centralize your Research and Quality Testing</h2>
        </div>
    ...
    <div className="tab-pane fade show active" id="tabs-1" role="tabpanel">
                    ...
                    <div className="col-lg-7 pt-0">
                        <div className="tab-content" id="v-pills-tabContent">
                            ...
                            <div className="software_service_item mb-70">
                              <Image src={Eliminate_Paper} className="img-fluid  elnimage_size-tab" 
                              alt="Collaborate globally and maintain a centralized repository of your 
                              experiments — access Logilab Electronic Lab Notebook anytime, anywhere through a browser."/>
                             </div>
                            </div>
                            <div className="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <div className="software_service_item mb-70">
                    ...
                    <div className="col-lg-7 pt-0">
                      <div className="tab-content" id="v-pills-tabContent">
                        <div className="tab-pane fade show active" id="v-pills-home1" role="tabpanel" aria-labelledby="v-pills-home-tab">
                          <div className="software_service_item mb-70">
                          <Image src={Lab_Task} className="img-fluid  elnimage_size-tab" 
                          alt="Conduct assays on samples and execute SOPs with Logilab ELN Software — capture 
                          data in multiple formats such as tables, images, chemical drawings and more."/>  
                    ...
                    <div className="col-lg-7 pt-0">
                      <div className="tab-content" id="v-pills-tabContent">
                        <div className="tab-pane fade show active" id="v-pills-home4" role="tabpanel" aria-labelledby="v-pills-home-tab">
                          <div className="software_service_item mb-70">
                          <Image src={RD} className="img-fluid  elnimage_size-tab" 
                          alt="Record and monitor lab activites, calibrate instruments, perform test procedures 
                          and develop analytical methods with Logilab Electronic Lab Notebook."/> 
                          </div>
                        </div>
        ...
        <div>
            <div className="container mt-5 sec_title ">
                <h2 className="text-center my-5">Automate All Manual Lab Processes</h2>
                <div className="row boxheight">
                    <div className="col-lg-4 ">
                        <div className="boxshow homecontentbefore py-5">
                            <Image src={share} className="img-fluid " 
                            alt="Elevate collboration and ensure adherence to ALCOA Data Integrity principles 
                            with  Electronic Lab Notebook." style={{ width: '100px', height: '90px' }}/>
                    ...
                    <div className="col-lg-4 ">
                        <div className="boxshow py-5">
                            <Image src={Reduce} className="img-fluid " 
                            alt="Simplify lab record-keeping with Electronic Lab Notebook's standardized 
                            spreadsheet and protocol templates" 
                    ...
                    <div className="col-lg-4 ">
                        <div className="boxshow homecontentafter py-5">
                            <Image src={Doc} className="img-fluid " 
                            alt="Stay compliant to 21 CFR Part 11 and GLP with Electronic Lab Notebook." 
                      ...
                      <div className="row">
                        <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center">
                          <div className=" text-center logpositionchange">
                              ...
                              <h3 className="Ensure mt-3 f_800">Try for 30 Days <br/>Simplify your  Lab's Workflow </h3>
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-6 order-first order-lg-last d-flex flex-column justify-content-center align-items-center ">                            
                                      <div className="text-center">
                                         ...
                                         <h4 className="text-white mt-3 f_800">Digitize. Simplify. Organize.</h4>
