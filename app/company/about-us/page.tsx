    ...
    const facts = [
        {
          ...
          count: 250,
          text: 'Customers across several Industries',
        },
        {
        ...
        {
          title: 'Team of more than',
          count: 100,
          text: 'Team Members',
        },
        {
          title: 'Enterprise class solution    stack of',
          count: 5,
          text: 'Products',
        },
      ]
                    ...
                    <Row>
                        <Col lg={4}>
                            <div className="modern-number-01">
                                <h2 className="heading me-5"><span className="mark-text">20+</span>Years of Excellence </h2>
            ...
            <Container>
                ...
                <Col lg={12}>
                    ...
                    >
                        ...
                        /> */}
                        <Image src={logilabserver2} className="img-fluid mb_20" alt=""/> 
                          </div>
                    ...
                    >
                        ...
                        <h6 className="heading">Cloud-based logilab eln <br/>launched</h6>
                        </div>
                    </div>
                    <div
                        className="item item-1 animate wow fadeInRight"
