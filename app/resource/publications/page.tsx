            ...
            <div className='publication-home'>
                                    ...
                                    <div className='container'>
                                        <div className='row'>
                                            <div className='col-lg-8'>
                                                <div>
                                                    <div className='mt-2'>
                                                        <Link  href='/whitepaper-download' className="er_btn er_btn_two ">Featured Whitepaper</Link>
                                                    </div>
                                                    <div> 
                                            ...
                                            <div className='col-lg-4 pt_130 publication-img'>
                                                <div className=''>
                                                    ...
                                                    <Link  href='/whitepaper-download'className="er_btn er_btn_two"> Get Your Copy Now </Link>
                                                </div>
                                            </div>
                                        </div>  
                                    </div>
                ...
                <div className='container'> 
                    ...
                    <div className='row mx-2  pb-5'>
                     ...
                     <div className="card publication-white-cards">
                        <div className='public-card-hover'>
                        <Image  alt='' src={Publicwhite} className="w-100 img-fluid"/>
                             <div className="card-body px-4 py-2">
                             <a className='publication-category'>Case Study</a>
                     ...
                     <div className='col-lg-6 col-md-6 mt-5'>
                        ...
                        <div className='col-lg-6 col-md-6 mt-5 publication-poster'>
                            {/* <img src='../../assets/images/publication/Frame 88.svg'/>  */}
                            <Link href='https://logilabelnlite.azurewebsites.net/register'>
                            <Image  alt='' src={poster} className="w-100 img-fluid"  /> 
                            </Link>
                ...
                <div className='container'>
                    <div className='row mx-2'>
                       <div className='col-lg-6 px-5 Faq-section-pading-left-right'>
                               <div className='faq-card mt-5'>
                                    ...
                                    <Link  href='https://helpcenter.agaramtech.com/helpcenter/elnartical/elntroublearticle/'className='d-block text-end px-5 pt-5 HelpCenter' >Help Center <span> 
                       ...
                       <div className=' faq-card-tow  mt-5'> 
                                    ...
                                    <p className='mx-5 pt-4 quickDemo'>Click the link below to schedule a quick Demo  </p>
                                    <div className='d-flex justify-content-end px-5 mt-5 HelpCentertwo'>
