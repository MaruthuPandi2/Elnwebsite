...
function Plan () {
    ...
    const calculateTotal = () => {
      ...
      setCalculatedPrices({
        ...
        liteMonthly: Math.round(unit_price.lite * 0.9000 * 100) / 100,
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="breadcrumb_box bannerresolution text-center">
                                ...
                                <div className="action_btn hero-button mt-30">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="section-title-wrapper text-center mb-20 wow move-up animated" >
                                                ...
                                                {/* <input type="number"  min="1" max="200" value={qty} className="qty" id="qty" 
                                                // onChange={handleQtyChange} 
                                                onChange={(e:any)=>{
                                                  console.log('onchange clicked')
                                                }} 
                                                onChangeCapture={(e:any)=>{
                                                  console.log('onChangeCapture clicked')
                                                }} 
                                                // onChangeCapture={handleQtyChange}
                                                style={{marginBottom:"20px"}}/> */}
                                                {errorMsg && (<span id="errorMsg" style={{color:"red", display:"block"}}>`*For teams larger than ${qty}, check out our Enterprise  plan`</span>)}<br/>
    ...
    <thead>
	 <tr>
        ...
        <tr style={{height:"140px"}}>
            ...
            <th className="tableth"><div className="hero-button mt-40 text-center mb-40">
                                    <a href="/contact-us" target="blank" style={{padding:"0 18px",lineHeight:"35px",height:"34px"}} className="btn btn--blue">Contact Us</a>
