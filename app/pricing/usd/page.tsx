...
function Plan () {
    ...
    const calculateTotal = () => {
      ...
      setCalculatedPrices({
        ...
        standardMonthly: Math.round(unit_price.standard * 0.9000 * 100) / 100,
        premiumMonthly: Math.round(unit_price.premium * 0.9000 * 100) / 100,
        ...
        yearlyLite: parseFloat((unit_price.lite * discount * 0.9).toFixed(2)), // Discount + additional discount
  ...
  const handleQtyChange = (e: { target: { value: string; }; }) => {
