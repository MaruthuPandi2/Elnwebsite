...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'http://5.189.171.17:9095/elnwebsitenext/assets/images/Logilab-ELN_white.svg', 
        width: 1200,
        height: 630,
        alt: 'About Us Image',
      },
  ...
  twitter: {
    ...
    title: 'About Us | My Website',
    description: 'Learn more about our company.',
    images: ['http://5.189.171.17:9095/elnwebsitenext/assets/images/Logilab-ELN_white.svg'], 
  },
}
  ...
  return (
    <>
      <Head>
        ...
        <meta property="twitter:image" content="http://5.189.171.17:9095/elnwebsitenext/assets/images/Logilab-ELN_white.svg" />
      </Head>
      <div>{children}</div>
    </>
  );
