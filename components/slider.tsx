...
import dbos from '../../eln/public/assets/images/customers/hp.png'
    ...
    <div className="slidedot">
      <OwlCarousel className="owl-theme" {...options}>
        <div className="item single-logo">
          ...
          <Image src={dbos} className="img-fluid slideimag" alt="Hindustan Petroleum Corporation Limited, India (HPCL)"/>
        </div>
        <div className="item single-logo">
